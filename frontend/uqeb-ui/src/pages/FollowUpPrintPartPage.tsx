      ...
      <div className="no-print mb-3">
        <div className="follow-up-print-top-bar">
          ...
          <Link to="/follow-up-print/pending" className="btn btn-outline">
            بانتظار تسجيل التعقيب
          </Link>
        </div>

        {marked ? (
          <Alert variant="success">
            تم تسجيل طلب الطباعة. اذهب إلى «بانتظار تسجيل التعقيب» لتأكيد الطباعة وتسجيل التعقيب.
          </Alert>
        ) : (
          <Alert variant="info">
            انقر «طباعة الآن» لفتح نافذة الطباعة، ثم اطبع أو احفظ PDF.
            بعد الطباعة اذهب إلى «بانتظار تسجيل التعقيب» لتأكيد الطباعة وتسجيل التعقيب.
