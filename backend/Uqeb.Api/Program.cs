...
builder.Services.AddSingleton<IReportingPlaywrightBrowserHost, ReportingPlaywrightBrowserHost>();
...
builder.Services.AddSingleton<IReportingCorrelationIdProvider, ReportingCorrelationIdProvider>();
builder.Services.AddSingleton<IReportingExportResourceGuard, ReportingExportResourceGuard>();
builder.Services.AddScoped<IReportingExportScopeFactory, ReportingExportScopeFactory>();
builder.Services.AddScoped<IReportingExportAdmissionService, ReportingExportAdmissionService>();
builder.Services.AddScoped<IReportingExportLifecycleObserver, ReportingExportLifecycleObserver>();
