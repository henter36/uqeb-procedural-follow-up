...
namespace Uqeb.Api.Migrations
{
    ...
    [Migration("20260709020524_AddDataQualityReviewTransactionForeignKey")]
    partial class AddDataQualityReviewTransactionForeignKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Uqeb.Api.Models.Entities.DepartmentResponse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Uqeb.Api.Models.Entities.DepartmentResponseAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DepartmentResponseId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DepartmentResponseId");

                    b.HasIndex("UploadedByUserId");

                    b.HasIndex("DepartmentResponseId", "IsDeleted");

                    b.ToTable("DepartmentResponseAttachments");
                });
            ...
            modelBuilder.Entity("Uqeb.Api.Models.Entities.LetterTemplate", b =>
                {
                    ...
                    b.Property<string>("DefaultSignatoryPosition")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("DefaultSignatoryRank")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("Uqeb.Api.Models.Entities.RecurringTransactionTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("DefaultReplyDueDays")
                        .HasColumnType("int");

                    b.Property<string>("DefaultRequiredAction")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("NextTransactionCreationMethod")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ResumedById");

                    b.HasIndex("Status");

                    b.HasIndex("TerminatedById");

                    b.ToTable("RecurringTransactionTemplates");
                });

            modelBuilder.Entity("Uqeb.Api.Models.Entities.RecurringTransactionTemplateDepartment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TemplateId", "DepartmentId")
                        .IsUnique();

                    b.ToTable("RecurringTransactionTemplateDepartments");
                });
            ...
            modelBuilder.Entity("Uqeb.Api.Models.Entities.ReportExportTemplate", b =>
                {
                    ...
                    b.Property<int>("DetailSortBy")
                        .HasColumnType("int");

                    b.Property<bool>("GroupDetailsByDepartment")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Uqeb.Api.Models.Entities.Transaction", b =>
                {
                    ...
                    b.Property<string>("RecurringPeriodKey")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("RecurringPeriodLabel")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("RecurringTemplateId", "RecurringPeriodKey")
                        .IsUnique()
            ...
            modelBuilder.Entity("Uqeb.Api.Reporting.DataQuality.DataQualityReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TransactionId", "RuleCode");

                    b.ToTable("DataQualityReviews");
                });
            ...
            modelBuilder.Entity("Uqeb.Api.Models.Entities.DepartmentResponse", b =>
                {
                    ...
                    b.HasOne("Uqeb.Api.Models.Entities.User", "ReviewedBy")
                        .WithMany()
                        .HasForeignKey("ReviewedByUserId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Uqeb.Api.Models.Entities.User", "SubmittedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Uqeb.Api.Models.Entities.DepartmentResponseAttachment", b =>
                {
                    b.HasOne("Uqeb.Api.Models.Entities.User", "DeletedBy")
                        .WithMany()
                        .HasForeignKey("DeletedByUserId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Uqeb.Api.Models.Entities.DepartmentResponse", "DepartmentResponse")
                        .WithMany("Attachments")
                        .HasForeignKey("DepartmentResponseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("DepartmentResponse");
            ...
            modelBuilder.Entity("Uqeb.Api.Models.Entities.RecurringTransactionTemplate", b =>
                {
                    ...
                    b.HasOne("Uqeb.Api.Models.Entities.User", "PausedBy")
                        .WithMany()
                        .HasForeignKey("PausedById")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Uqeb.Api.Models.Entities.User", "ResumedBy")
                        .WithMany()
                        .HasForeignKey("ResumedById")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Uqeb.Api.Models.Entities.User", "TerminatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Uqeb.Api.Models.Entities.RecurringTransactionTemplateDepartment", b =>
                {
                    ...
                    b.HasOne("Uqeb.Api.Models.Entities.RecurringTransactionTemplate", "Template")
                        .WithMany("Departments")
                        .HasForeignKey("TemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Uqeb.Api.Models.Entities.Transaction", b =>
                {
                    ...
                    b.HasOne("Uqeb.Api.Models.Entities.RecurringTransactionTemplate", "RecurringTemplate")
            ...
            modelBuilder.Entity("Uqeb.Api.Reporting.DataQuality.DataQualityReview", b =>
                {
                    ...
                    b.HasOne("Uqeb.Api.Models.Entities.Transaction", null)
                        .WithMany()
                        .HasForeignKey("TransactionId")
                        .OnDelete(DeleteBehavior.NoAction);
                });
